...
export type GetExtensionAnalyticsParams = operations['get-extension-analytics']['parameters']['query'];
export type GetGameAnalyticsParams = operations['get-game-analytics']['parameters']['query'];
export type GetBitsLeaderboardParams = operations['get-bits-leaderboard']['parameters']['query'];
export type GetCheermotesParams = operations['get-cheermotes']['parameters']['query'];
export type GetExtensionTransactionsParams = operations['get-extension-transactions']['parameters']['query'];
...
export type UpdateCustomRewardParams = operations['update-custom-reward']['parameters']['query'];
export type GetCustomRewardRedemptionParams = operations['get-custom-reward-redemption']['parameters']['query'];
export type UpdateRedemptionStatusParams = operations['update-redemption-status']['parameters']['query'];
export type GetCharityCampaignParams = operations['get-charity-campaign']['parameters']['query'];
export type GetCharityCampaignDonationsParams = operations['get-charity-campaign-donations']['parameters']['query'];
...
export type GetExtensionLiveChannelsParams = operations['get-extension-live-channels']['parameters']['query'];
export type CreateExtensionSecretParams = operations['create-extension-secret']['parameters']['query'];
export type SendExtensionChatMessageParams = operations['send-extension-chat-message']['parameters']['query'];
export type GetExtensionsParams = operations['get-extensions']['parameters']['query'];
export type GetReleasedExtensionsParams = operations['get-released-extensions']['parameters']['query'];
export type GetExtensionBitsProductsParams = operations['get-extension-bits-products']['parameters']['query'];
export type DeleteEventSubSubscriptionParams = operations['delete-eventsub-subscription']['parameters']['query'];
export type GetEventSubSubscriptionsParams = operations['get-eventsub-subscriptions']['parameters']['query'];
...
export type UpdateAutoModSettingsParams = operations['update-automod-settings']['parameters']['query'];
export type GetBannedUsersParams = operations['get-banned-users']['parameters']['query'];
export type BanUserParams = operations['ban-user']['parameters']['query'];
export type UnbanUserParams = operations['unban-user']['parameters']['query'];
export type GetBlockedTermsParams = operations['get-blocked-terms']['parameters']['query'];
export type AddBlockedTermParams = operations['add-blocked-term']['parameters']['query'];
export type RemoveBlockedTermParams = operations['remove-blocked-term']['parameters']['query'];
export type DeleteChatMessagesParams = operations['delete-chat-messages']['parameters']['query'];
export type GetModeratorsParams = operations['get-moderators']['parameters']['query'];
export type AddChannelModeratorParams = operations['add-channel-moderator']['parameters']['query'];
export type RemoveChannelModeratorParams = operations['remove-channel-moderator']['parameters']['query'];
...
export type CancelRaidParams = operations['cancel-a-raid']['parameters']['query'];
export type GetChannelStreamScheduleParams = operations['get-channel-stream-schedule']['parameters']['query'];
export type GetChannelICalendarParams = operations['get-channel-icalendar']['parameters']['query'];
export type UpdateChannelStreamScheduleParams = operations['update-channel-stream-schedule']['parameters']['query'];
export type CreateChannelStreamScheduleSegmentParams = operations['create-channel-stream-schedule-segment']['parameters']['query'];
export type UpdateChannelStreamScheduleSegmentParams = operations['update-channel-stream-schedule-segment']['parameters']['query'];
...
export type GetUserActiveExtensionsParams = operations['get-user-active-extensions']['parameters']['query'];
